...
int main(int argc, char *argv[])
{
    ...
    // after exploring full maze go back to startand start planning
    ...
    log("Dijkstra path planning:\nStart Time = " + currentDateTime());
    dijkstra_search(graph, map, Coordinates{x, y}, Coordinates{EXPLORED_GOAL_X, EXPLORED_GOAL_Y}, came_from, cost_so_far, path);
    log("End Time = " + currentDateTime());
    followpath(map, path);
    ...
    aStar_search(graph, map, Coordinates{x, y}, Coordinates{EXPLORED_GOAL_X, EXPLORED_GOAL_Y}, came_from_aStar, cost_so_far_aStar, path_aStar);
    log("End Time = " + currentDateTime());
